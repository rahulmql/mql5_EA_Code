...
#include  <trade/trade.mqh>
   ...
   // Define parameters
   double lotSize = 0.01; // Risk management
   input int atrPeriod = 21; // ATR period for dynamic stop-loss/take-profit
   input double riskRewardRatio = 2; // Risk-reward ratio
   input ENUM_TIMEFRAMES higherTFPeriod = PERIOD_M15; // Higher timeframe for trend confirmation
   input int higherTFMAPeriod = 100; // Higher timeframe SMA period
   int Magic = 111222333;
