...
#include  <trade/trade.mqh>
   ...
   double riskRewardRatio = 3; // Risk-reward ratio
   ENUM_TIMEFRAMES higherTFPeriod = PERIOD_M15; // Higher timeframe for trend confirmation
   int higherTFMAPeriod = 70; // Higher timeframe SMA period
   int Magic = 111222333;
